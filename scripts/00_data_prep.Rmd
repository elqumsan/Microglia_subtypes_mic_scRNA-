...
we can explore of the primary source of hetrogeneity in our datawe trying to decide which PCs to include for further downstream analysis, by which both cells and features are ordered accoording to their PCA scores. this for exploring correlated feature set
```{r}
VizDimLoadings(scale_data, dims = 1:2 , reduction = "pca")
